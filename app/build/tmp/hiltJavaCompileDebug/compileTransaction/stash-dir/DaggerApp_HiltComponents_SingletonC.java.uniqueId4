...
import com.example.electromaze.presentation.MainActivity;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(ViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private BluetoothController bluetoothController() {
      return new BluetoothController(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
    }

    private GyroController gyroController() {
      return new GyroController(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam,
        final ViewModelLifecycle viewModelLifecycleParam) {
      this.viewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<androidx.lifecycle.ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<androidx.lifecycle.ViewModel>>singletonMap("com.example.electromaze.ViewModel", ((Provider) viewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.electromaze.ViewModel 
          return (T) new ViewModel(viewModelCImpl.bluetoothController(), viewModelCImpl.gyroController());
